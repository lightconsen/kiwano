...
export const strategy = {
  ...
  limitCurrencyNote:
    "A money limit is written in a currency this agent's providers bill in — spending in another is converted at the Hub's rates before it counts. The ceiling itself never converts.",
};
