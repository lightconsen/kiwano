...
// Source: src-tauri/src/proxy/tool_media.rs
// Copied on 2026-09-07. Modified for Kiwano (added only because transform.rs depends on it; not listed in the original extraction plan).

#![allow(dead_code)] // upstream helpers kept verbatim; their callers live in out-of-scope cc-switch modules
